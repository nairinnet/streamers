...
public class CommonMessage {
    ...
    protected NSEOutputStream out = null;
    ...
    public CommonMessage(){
        ...
        out = new NSEOutputStream(bufferOut);
    }
     ...
     */
    public String toString(NSEInputStream in, byte index, boolean divide) throws Exception{
        String tmp = "";
    ...
    public byte readByte(NSEInputStream in) throws Exception {
        return in.readByte();
    }
    
    public short readShort(NSEInputStream in) throws Exception {
        return in.readShort();
    }
    
    public short readUnsignedShort(NSEInputStream in) throws Exception {
        return in.readShort();
    }
    
    public int readInt(NSEInputStream in) throws Exception {
        return in.readInt();
    }
    
    public long readUnsignedInt(NSEInputStream in) throws Exception {
        return (in.readInt() & 0xFFFFFFFFL);
    }
    
    public long readLong(NSEInputStream in) throws Exception {
        return in.readLong();
    }
    
    
    public double readDouble(NSEInputStream in) throws Exception {
        return in.readDouble();
    }
    
    public void skipBytes(NSEInputStream in, int noOfBytes) throws Exception {
